...
Status: **proposal** for review. The pinned compiler is `typeshade/typeshade` at `be732ca`
...
mapping in §3 stands as written. The moves from `ef049e4` to `eb0dde6`, on to `7f0b482` and on to `be732ca` remove nothing this
